          ...
          <div style="left: 0" class="modal-body">
            ...
            >
              <form>
                ...
                <div
                  style="margin-top: 9%; display: flex; justify-content: center"
                >
                ...
                >
                  <p
                    ...
                    class="text-black"
                  >
                    Note: Once you have created a Papaya Account, you cannot
                    change your e-mail address and password. In case you need to
                    change your e-mail or password, please do not hesitate to
                    contact us.
                  </p>
                </div>
              </form>
...
<script>
import Client from './ClientReg.vue';
import Bussines from './BussinesForm.vue';
import Company from './CompanyReg.vue'
export default{
    components:{
        Client,
        Bussines,
